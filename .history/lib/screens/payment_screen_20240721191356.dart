...
import 'package:shop_app/blocs/history/history_bloc.dart';
                  ...
                  return GestureDetector(
                    onTap: () {
                      if (state is CartLoaded) {
                        for (Item item in state.cart.products) {
                          context
                              .read<HistoryBloc>()
                              .add(HistoryProductAdded(item));
                        }
                        Navigator.pushNamed(
                          context,
                    ...
                    child: Container(
                      ...
                      child: Center(
                          child:state is CartLoading? Text(
                        'Make Payment',
                        style: TextStyle(
                            color: Color(0xff2A2A2A),
                            fontSize: 13,
